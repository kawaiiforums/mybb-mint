<div class="mint__table__row mint__balance-operation mint__balance-operation--{$type}">
    <div class="mint__table__row__cell mint__table__row__cell--align-right" style="width: 20%">
